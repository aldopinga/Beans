	...
	public function page( $page ) {
		...
		echo '<form action="" method="post" class="bs-options" data-page="' . beans_get( 'page' ) . '">';
			...
			echo '<p class="bs-options-form-actions">
				<input type="submit" name="beans_save_options" value="' . esc_attr__( 'Save', 'beans' ) . '" class="button-primary">
				<input type="submit" name="beans_reset_options" value="' . esc_attr__( 'Reset', 'beans' ) . '" class="button-secondary">
			</p>';
